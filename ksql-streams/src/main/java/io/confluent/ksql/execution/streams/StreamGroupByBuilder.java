...
public final class StreamGroupByBuilder {
  ...
  public static KGroupedStream<Object, GenericRow> build(
    ...
    final Grouped<Object, GenericRow> grouped = buildGrouped(
        formats,
        sourceSchema,
        queryContext,
        queryBuilder,
  ...
  private static Grouped<Object, GenericRow> buildGrouped(
